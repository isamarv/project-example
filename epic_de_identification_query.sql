/* 
-----------------------------------------------------------------------------------------------------------------
-- Abax Healthcare, Inc — EPIC CLARITY HELPER QUERY
-- Purpose: De-identification query for POC Scripts
-- This query wraps patient and order identifiers with randomized padding
-- to anonymize output while preserving referential structure for analysis.
-----------------------------------------------------------------------------------------------------------------
*/
